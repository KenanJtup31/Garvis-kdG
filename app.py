...
if sual := st.chat_input("Jarvisə bir şey soruş..."):
    ...
    with st.chat_message("assistant"):
        with st.spinner("Jarvis analiz edir..."):
          ...
          # 3. Məntiq - Jarvisin kimliyini burada təyin edirik
if "messages" not in st.session_state: 
    st.session_state.messages = [
        {"role": "system", "content": "Sənin adın Langur Jarvis-dir. Səni Kənan Əlizadə (KDG) yaradıb. Sən çox köməksevər, ağıllı və mehriban bir süni intellektsən. Sənə kim olduğun soruşulsa, mütləq Kənan Əlizadə tərəfindən yaradıldığını bildirməlisən."}
    ]
